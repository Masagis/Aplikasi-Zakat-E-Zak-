...
public class Pengguna extends javax.swing.JFrame {
    ...
    public Pengguna() {
        ...
        Tabelcd.addColumn("Hak Akses");
        setLocationRelativeTo(null);
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Pengguna | EZAK ITERA");
    }
void waktu ()
    {
        try
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(431, 354));
        ...
        jLabel2.setText("Pengguna E-Zak");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 220, -1));

        tanggal.setFont(new java.awt.Font("Liberation Sans Narrow", 1, 18)); // NOI18N
        tanggal.setText("tanggal");
        jPanel1.add(tanggal, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 0, 90, -1));

        tampil_jam.setFont(new java.awt.Font("Liberation Sans Narrow", 1, 18)); // NOI18N
        tampil_jam.setText("jLabel2");
        jPanel1.add(tampil_jam, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 20, 90, -1));
        ...
        getContentPane().add(tampil, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, -1, -1));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama", "Password", "Hak Akses"
            }
        ));
        jTable1.setOpaque(false);
        jScrollPane1.setViewportView(jTable1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 350, 100));
        ...
        getContentPane().add(user, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 80, 140, 30));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Ejak/gambar/backgroud login.jpg"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(199, -2, 240, 360));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            Statement st = db.getConnection().createStatement();
            String sql = "delete from pengguna where username= '"+user.getText()+"'";
